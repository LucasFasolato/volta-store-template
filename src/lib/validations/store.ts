...
export const storeThemeSchema = z
  .object({
    ...
    font_preset: z.enum(['elegant', 'modern', 'minimal', 'bold']),
    heading_font: z.enum(['geist', 'inter', 'manrope', 'plus-jakarta']),
    body_font: z.enum(['geist', 'inter', 'manrope', 'plus-jakarta']),
    font_family: z.enum(['geist', 'inter', 'manrope', 'plus-jakarta']),
