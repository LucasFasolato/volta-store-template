...
export function CategoriasList({ categories: initialCategories }: CategoriasListProps) {
  ...
  async function handleDelete(id: string, name: string) {
    if (!confirm(`Eliminar la categoria "${name}"? Los productos quedaran sin categoria.`)) return
    ...
    <div className="space-y-5">
      {categories.length === 0 && !showNew ? (
        <EmptyState
          ...
          description="Crea una primera categoria para ordenar mejor el catalogo y ayudar a navegar desde el celular."
          action={
            <Button
              type="button"
            ...
            {editingId === category.id ? (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Button type="submit" size="sm" className="rounded-full bg-emerald-400 text-black hover:bg-emerald-300">
