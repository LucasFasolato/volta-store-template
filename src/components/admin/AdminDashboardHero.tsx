...
export function AdminDashboardHero({ plan: _plan, storeName }: { plan: StoreLaunchPlan; storeName: string }) {
  return (
    <section className="rounded-[18px] border border-black/8 bg-white p-4 dark:border-white/10 dark:bg-[#111820] sm:p-5">
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 sm:flex">
        <Link href="/admin/vista-previa" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[10px] bg-[#12e89a] px-4 text-sm font-semibold text-[#062117]"><Eye className="size-4" />Ver mi tienda</Link>
