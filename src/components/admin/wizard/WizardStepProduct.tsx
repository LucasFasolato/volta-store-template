...
export function WizardStepProduct({
  ...
  function handleAdd() {
    ...
    if (isNaN(priceNum) || priceNum <= 0) return setError('Ingresá un precio mayor a 0.')
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <Input inputMode="decimal" value={price} onChange={(event) => setPrice(event.target.value)} placeholder="25000" disabled={isPending} className="h-12 rounded-[10px] bg-white dark:bg-white/5" />
      </div>
