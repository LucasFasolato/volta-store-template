...
export function MobileAdminNav() {
  ...
  return (
    <div className="fixed inset-x-2.5 bottom-2.5 z-50 lg:hidden">
      <Link href="/admin/vista-previa" className="mx-auto mb-2 flex min-h-11 w-fit items-center gap-2 rounded-full bg-[#10161d] px-5 text-sm font-semibold text-white shadow-lg dark:bg-white dark:text-slate-950">
        <Eye className="size-4 text-[#12e89a]" />
        Ver mi tienda
      </Link>
      <nav className="mobile-admin-nav safe-area-pb" aria-label="Navegación principal">
