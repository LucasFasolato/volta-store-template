...
import { getAdminBrands, getAdminCategories } from '@/lib/queries/store'
  ...
  return (
    <div className="volta-admin-page p-3.5 sm:p-5 lg:p-6">
      ...
      <header className="mb-5 pr-36 sm:pr-44">
        ...
        <p className="mt-1.5 max-w-xl text-sm leading-6 text-muted-foreground">Imagen, nombre y precio primero. Categoría, marca y SKU ayudan cuando el catálogo crece.</p>
      </header>
