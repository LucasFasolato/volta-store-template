        ...
        <section className="w-full max-w-lg rounded-[28px] border border-black/8 bg-white p-6 shadow-[0_24px_80px_rgba(15,23,42,.08)] sm:p-9">
          ...
          {tokenHash ? (
            ...
            <>
              ...
              <Link
                href="/login"
                className="mt-8 inline-flex h-12 w-full items-center justify-center rounded-full bg-[#10161d] px-5 text-sm font-semibold text-white transition hover:bg-[#18212b]"
              >
                Volver al ingreso
              </Link>
            </>
